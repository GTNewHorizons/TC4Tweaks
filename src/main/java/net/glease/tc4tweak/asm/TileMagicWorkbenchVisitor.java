...
class TileMagicWorkbenchVisitor extends ClassVisitor {
    ...
    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        if (name.equals("func_70299_a")
                || name.equals("setInventorySlotContents") && desc.equals("(ILnet/minecraft/item/ItemStack;)V")) {
            TC4Transformer.log.debug("Altering {}(ILnet/minecraft/item/ItemStack;)V", name);
            return new SetInventorySlotContentsVisitor(
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
            if ((name.equals("onCraftMatrixChanged") || name.equals("func_75130_a"))
                ...
                mv.visitMethodInsn(
                        ...
                        "(Lthaumcraft/common/tiles/TileMagicWorkbench;)V",
                        false);
            } else {
