...
class ThaumcraftApiVisitor extends ClassVisitor {
    ...
    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        } else if ("getCrucibleRecipeFromHash".equals(name)
                && "(I)Lthaumcraft/api/crafting/CrucibleRecipe;".equals(desc)) {
    ...
    private static class ClinitVisitor extends MethodVisitor {
        ...
        public void visitInsn(int opcode) {
            if (opcode == RETURN)
                mv.visitMethodInsn(
                        INVOKESTATIC, ASMCALLHOOKSERVER_INTERNAL_NAME, "postThaumcraftApiClinit", "()V", false);
