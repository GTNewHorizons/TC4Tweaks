...
class ContainerArcaneWorkbenchVisitor extends ClassVisitor {
    ...
    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        if (desc.equals("(Lnet/minecraft/inventory/IInventory;)V") && dev
                ? name.equals("onCraftMatrixChanged")
                : name.equals("func_75130_a")) {
            ...
            mv.visitFieldInsn(
                    ...
                    "tileEntity",
                    "Lthaumcraft/common/tiles/TileArcaneWorkbench;");
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(
                    GETFIELD,
                    "thaumcraft/common/container/ContainerArcaneWorkbench",
            ...
            mv.visitMethodInsn(
                    ...
                    "onArcaneWorkbenchChanged",
                    "(Lthaumcraft/common/tiles/TileArcaneWorkbench;Lnet/minecraft/entity/player/InventoryPlayer;)V",
                    false);
            mv.visitInsn(RETURN);
            mv.visitMaxs(1, 1);
            mv.visitEnd();
