...
class TESRGetBlockTypeNullSafetyVisitor extends ClassVisitor {
    static final TransformerFactory FACTORY =
            new TransformerFactory(TESRGetBlockTypeNullSafetyVisitor::new, Side.CLIENT);
    ...
    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        if ((name.equals("renderTileEntityAt") || name.equals("func_147500_a"))
                && desc.equals("(Lnet/minecraft/tileentity/TileEntity;DDDF)V")) {
    ...
    private static class RenderTileEntityAtVisitor extends MethodVisitor {
        ...
        public void visitCode() {
            ...
            mv.visitMethodInsn(
                    INVOKEVIRTUAL,
                    "net/minecraft/tileentity/TileEntity",
                    dev ? "getBlockType" : "func_145838_q",
